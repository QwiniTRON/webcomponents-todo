...
export default class MyItem extends HTMLElement {
    ...
    $done: HTMLInputElement | null = null
    $doneImg: HTMLImageElement | null = null
    $text: HTMLSpanElement | null = null
    $edit: HTMLElement | null = null
    $destroy: HTMLElement | null = null
    $editInput?: HTMLInputElement
    isEdit: boolean = false

    onClick: ((e: Event, detail: { detail: any, isDone: boolean} ) => void) | undefined
    onDelete: ((i: number) => void) | undefined
    onChangeHandler?: ((i: number, detail: {text: string, isEdit: boolean}) => void)
    ...
    connectedCallback() {
        ...
        this._text = this.getAttribute('text') as string
        ...
        // done change
        this.$done!.addEventListener('change', (event: Event) => {
    ...
    render() {
        this.$done!.checked = this._checked as boolean
        ...
        this.$text!.textContent = this._text as string
        this.$editInput!.value = this._text as string
